...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="admin-view-req-faculty.php"><i class="icofont-hand icofont-2x"></i>Faculty Request</a></li>
    ...
    <section>
        ...
        <div class="wrapper">
            ...
            if (isset($_POST['submit1'])) {
                mysqli_query($conn, "UPDATE faculty_issue_book SET approve='Approved',issue='$_POST[issue]',return_date='$_POST[return]' WHERE fid = '$_SESSION[fid]' and bid = '$_SESSION[bid]'");
            ...
            ?>
                <script type="text/javascript">
                    ...
                    window.location = "admin-view-req-faculty.php"
                </script>
            <?php
            }
            ?>
