    ...
    <section>
        ...
        <div class="wrapper">
            ...
            <div style="text-align: center;
                      ...
                      color: white;
                      font-size: 25px;
                            "><b>Student Book Request's </b>
            </div>
            <br><br>
            <div class="srch">
                <form action="http://localhost/library-website/admin/approve-student-sql.php" method="post">
                    <ul>
                        <li><input class="form-control" type="text" name="id" placeholder="Student ID.." required=""></li>
            ...
            <?php
            $res = mysqli_query($conn, "SELECT * FROM fileup INNER JOIN issue_book ON fileup.id = issue_book.bid ORDER BY sid;");
