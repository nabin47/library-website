...
<body>
    ...
    <div class="tb">
        <h1 style="padding-top: 70px; font-size: 1.5rem; font-weight: bold">List of books (CE Department)</h1>

        <!-- IF the search button is pressed-->
        <?php
        if (isset($_POST['submit'])) {
            $res = mysqli_query($conn, "SELECT * FROM `fileup` where title like '%$_POST[search]%' && department='CE' ");
        ...
        //If search button is not pressd
            ...
            $res = mysqli_query($conn, "SELECT * FROM `fileup` WHERE department='CE' ORDER BY id;");
            echo "<div class='table-responsive-md'>";
            echo "<table class='table table-bordered table-hover table-striped' style='font-size: 15px'>";
            echo "<thead class='thead-dark'>";
            echo "<tr style='background-color: #063247';>";
