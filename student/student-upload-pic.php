...
if (isset($_POST["submit"])) {
    ...
    $uploads_dir = 'C:\xampp\htdocs\library-website\student\img';
    move_uploaded_file($tname, $uploads_dir . '/' . $pname);
    if (!empty($tname)) {
        $sql = "UPDATE student SET pic='$pname' WHERE username='$_SESSION[login_user1]'";
...
?>
        ...
        ?>
            <script type="text/javascript">
                ...
                window.location = "student-upload-pic.php";
            </script>
        <?php
        }
    } else {
