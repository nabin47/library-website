...
<body>
    ...
    if (isset($_SESSION['login_user3'])) { ?>
        ...
        <section>
            ...
            <div class="wrapper">
                <?php
                $q = mysqli_query($conn, "SELECT * FROM faculty WHERE faculty_username='$_SESSION[login_user3]' ;");
                ?>
                ...
                ?>
                <div class="button">
                    <a href="faculty-upload-pic.php" class="btn">Upload Picture</a>
                </div>
                <div class="bt">
